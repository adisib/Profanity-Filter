...
let a=new RegExp("\\b(?:(?:f(?:a(?:g(?:(?:g[eio]|o)t)?|tass)|u(?:ck(?:me)?|k)|(?:cu|vc)k|eg)|b(?:u(?:llshit|ttfuck)|[!i]tch|astard)|ass(?:(?:hol|wip)e|clown|fuck|kiss)?|d(?:ipshit|umbass|ouche|amn)|p(?:hu(?:c?k|q)|iss(?:off)?)|sh(?:i(?:t(?:full)?|z)|!t)|moth(?:afucka?|erfuck)|c(?:rap|unt)|nig(?:ga)?|goddamn|jackass))[tgk]??(?:(?:i??er|ing?|ed))??(?:(?:[syz]|ess??))??\\b","gi"),b=document.evaluate("./*[not(self::script or self::noscript or self::code)]//text()[string-length(normalize-space()) > 2]",
