...
(function() {
    ...
    let textNodes = document.evaluate(".//text()[not(parent::script or parent::noscript or parent::code or parent::textarea) and string-length(normalize-space(.)) > 2]", document.body, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
